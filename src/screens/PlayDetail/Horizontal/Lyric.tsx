...
import { Animated, View, FlatList, type FlatListProps, type NativeSyntheticEvent, type NativeScrollEvent, type LayoutChangeEvent, Alert, Pressable, Text as RNText } from 'react-native'
