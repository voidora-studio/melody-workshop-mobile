...
export interface ListMenuProps {
  ...
  onExportTxt: (listInfo: LX.List.MyListInfo, index: number) => void
  onExportCsv: (listInfo: LX.List.MyListInfo, index: number) => void
...
export default forwardRef<ListMenuType, ListMenuProps>(({
  ...
  const handleSetMenu = (listInfo: LX.List.MyListInfo) => {
    ...
    setMenus([
      ...
      { action: 'exportTxt', label: t('list_export_txt') },
      { action: 'exportCsv', label: t('list_export_csv') },
  ...
  const handleMenuPress = ({ action }: typeof menus[number]) => {
    ...
    switch (action) {
      ...
      case 'export':
        ...
        break
      case 'exportTxt':
        onExportTxt(selectInfo.listInfo, selectInfo.index)
        break
      case 'exportCsv':
        onExportCsv(selectInfo.listInfo, selectInfo.index)
        break
      case 'sync':
