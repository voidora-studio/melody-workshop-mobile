...
import DuplicateMusicModal, { type DuplicateMusicModalType } from './DuplicateMusicModal'
...
export default () => {
  ...
  const duplicateMusicModalRef = useRef<DuplicateMusicModalType>(null)
  ...
  return (
    <View style={styles.container}>
      <View style={{ zIndex: 2 }}>
        <ActiveList ref={activeListRef} onShowSearchBar={handleShowSearch} onScrollToTop={hancelScrollToTop} onFindDuplicates={() => duplicateMusicModalRef.current?.show()} />
        <MultipleModeBar
      ...
      <ListMenu
        ...
        onDownload={info => void addDownload(info.musicInfo as LX.Music.MusicInfoOnline, undefined, info.listId)}
      ...
      <DuplicateMusicModal ref={duplicateMusicModalRef} />
    </View>
  )
}
