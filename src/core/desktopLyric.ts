...
export const showDesktopLyric = async() => {
  ...
  await showDesktopLyricView({
    ...
    // New settings (forward-compatible)
    lineGap: setting['desktopLyric.lineGap'],
    isZoomActiveLine: setting['desktopLyric.isZoomActiveLine'],
    fontWeight: setting['desktopLyric.style.fontWeight'],
    fontFamily: setting['desktopLyric.fontFamily'],
    direction: setting['desktopLyric.direction'],
    scrollAlign: setting['desktopLyric.scrollAlign'],
    textAlign: setting['desktopLyric.textAlign'],
    ellipsisMode: setting['desktopLyric.ellipsisMode'],
    lyricPlayedColorEnd: setting['desktopLyric.style.lyricPlayedColorEnd'],
  })
